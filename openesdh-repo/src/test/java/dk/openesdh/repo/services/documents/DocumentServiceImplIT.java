...
//    }
    ...
    @Test
    public void shouldCreateCaseDocument() {
        int size = documentService.getDocumentsForCase(testCase1).size();
        documentService.createDocument(testCase1, TEST_DOCUMENT_NAME, TEST_DOCUMENT_FILE_NAME,
        ...
        Assert.assertEquals("Size of documents increased by 1", size + 1, documentService.getDocumentsForCase(testCase1).size());
    }
}
