...
if (createContentConfig !== null) {
    ...
    if (contentConfigs) {
        ...
        for (var i = 0; i < contentConfigs.size() - 1; i++) { // Added the -1 to skip the addition of the folder icon for the create folder by templated node
...
var isMainDocumentView = {
    initialValue: false,
    rules: [{
        topic: "ALF_RETRIEVE_DOCUMENTS_REQUEST_SUCCESS",
        attribute: "response.caseCardView",
        isNot: [false]
    }]
};
                ...
                },
                {
                    ...
                    config: {
                        widgets: [
                            ...
                            {
                                id: "CASELIB_CASE_DOCUMENT_DETAILS",
                                name: "openesdh/pages/documents/views/MainDocumentDetails",
                                config: {
                                    visibilityConfig: isMainDocumentView
                                }
                            },
