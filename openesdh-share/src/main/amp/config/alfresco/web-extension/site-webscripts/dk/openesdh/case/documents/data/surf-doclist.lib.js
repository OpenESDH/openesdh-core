...
/**
 * Build the query arg string in a similar fashion to the getArgsAsParameters function of the
 * org.alfresco.web.resolver.doclib.DefaultDoclistDataUrlResolver class.
 * See https://github.com/Alfresco/community-edition/blob/master/projects/slingshot/source/java/org/alfresco/web/resolver/doclib/DefaultDoclistDataUrlResolver.java
  * @param args
 */
function getArgsAsParameters(args){
    var urlParameters ="";
    for(var i in args){
        urlParameters += i +"=" +encodeURIComponent(args[i]);
        urlParameters += "&";
    }
    //Remove trailing &
