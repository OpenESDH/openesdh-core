...
/**
 * @module alfresco/layouts/BootstrapGrid
...
define(["dojo/_base/declare",
        ...
        "dojo/text!./templates/BootstrapGrid.html",
        "dojo/dom-construct",
        "dojo/dom-class",
        "dojo/_base/array"], 
   ...
   return declare([ProcessWidgets, _SemanticWrapperMixin], {
       ...
       * @instance
       * @type {object[]}
       * @default [{cssFile:"./css/BootstrapGrid"}]
       */
      cssRequirements: [{cssFile:"./css/BootstrapGrid.css"}],
       ...
       * @instance
       */
      postCreate: function alfresco_layout_BootstrapGrid__postCreate() {
         ...
         if (this.widgets)
         {
            ...
            array.forEach(this.widgets, function(entry, i) {
               ...
               {*/
            	var className = entry.columnSize ? 'col-xs-' + entry.columnSize : 'col-xs-12';
            	
            	
                  domNode = this.createWidgetDomNode(entry, this.containerNode, className);
       ...
       */
      createWidgetDomNode: function alfresco_layout_BootstrapGrid__createWidgetDomNode(widget, rootNode, rootClassName) {
